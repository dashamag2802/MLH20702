...
describe('User cant choose more than 1 option', function () {
    ...
    it('A-114 user cant select he and she together', function () {      //TC-027
    ...
    it('A-115 user cant select he and it together', function () {      //TC-028
        const input1 = $$(sel.genderTypeK)[data.gender.he[0]].click();
    ...
    it('A-116 user cant select she and it together', function () {      //TC-029
    ...
    it('A-117 user cant select he, she and it together', function () {      //TC-030
        const input1 = $$(sel.genderTypeK)[data.gender.he[0]].click();
        const input2 = $$(sel.genderTypeK)[data.gender.she[0]].click();
