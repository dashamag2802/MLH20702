...
describe('Inputs for Age input field are correct', function () {
    ...
    it('A-040 Age accepts upper board integer', function () {     //TC-034
        browser.url('');
    ...
    it('A-041 Verify field accepts middle integer of the range ', function () {     //TC-035
        browser.url('');
    ...
    it('A-042 Functionality of increasing spinner', function () {    //TC-036
        browser.url('');
    ...
    it('A-043 Functionality of decreasing spinner', function () {    //TC-037
        browser.url('');
        inputValueAge(data.ageM3);
    ...
    it('A-044 Verify the functionality of the spinner with no value in the filed (increase)', function () {    //TC-038
        browser.url('');
        $$(sel.ageArrow)[0].click();
        const age1 = +$(sel.ageK).getValue();
