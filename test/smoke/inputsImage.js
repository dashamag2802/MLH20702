...
describe('Inputs for Image input field are correct', function () {
    ...
    it('A-052 Image input file able to browse', function () {   // TC-062
        browser.url('');
    ...
    it('A-053 Input for Image jpeg file by browsing form the computer', function () {   // TC-063
        browser.url('');
    ...
    it('A-054 Input for Image png file by browsing form the computer', function () {   // TC-064
        browser.url('');
    ...
    it('A-055 Input for Image file 200px', function () {        // TC-065
        browser.url('');
    ...
    it('A-056 Input for Image file 500px', function () {   // TC-066
        browser.url('');
    ...
    it('A-057 Input for Image file more than 500px', function () {   // TC-067
        browser.url('');
    ...
    it('A-058 Input for Image file delete after upload', function () {   // TC-068
        browser.url('');
        uploadImageBrowser(data.imageChoice.PNGMore500px);
