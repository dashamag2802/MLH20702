...
describe('Inputs for Story type are correct', function () {
    ...
    it('A-045 Story type = Overcoming the Monster', function () {      //TC-049
        browser.url('');
    ...
    it('A-046 Story type = Rebirth', function () {      //TC-050
        browser.url('');
        const click = $(sel.storyClickK).click();
    ...
    it('A-047 Story type = Quest', function () {      //TC-051
        browser.url('');
        const click = $(sel.storyClickK).click();
    ...
    it('A-048 Story type = Journey and Return', function () {      //TC-052
        browser.url('');
        const click = $(sel.storyClickK).click();
    ...
    it('A-049 Story type = Rags and Riches', function () {      //TC-053
        browser.url('');
        const click = $(sel.storyClickK).click();
    ...
    it('A-050 Story type = Tragedy', function () {      //TC-054
        browser.url('');
        const click = $(sel.storyClickK).click();
    ...
    it('A-051 Story type = Comedy', function () {      //TC-055
        browser.url('');
        const click = $(sel.storyClickK).click();
