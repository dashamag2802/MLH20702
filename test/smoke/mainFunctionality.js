...
describe('Checking the main functionality', function () {
    ...
    describe('Happy path', function () {
        ...
        it('A-052 Create button is clickable after 1-4 are filled in', function () {     //TC-079
            browser.url('');
        ...
        it('A-053 Create button is clickable after 1-5 are filled in', function () {     //TC-080
            browser.url('');
    ...
    describe('Other paths', function () {
        ...
        it('A-054 gender he is working', function () {
            browser.url('');
        ...
        it('A-055 gender it is working', function () {
            browser.url('');
    ...
    describe('Check Story content', function () {
        ...
        describe('A-056 Story content correspond to 1-4 fields', function () {      //TC-087
            ...
            it('A-056-1 Story content correspond to name', function () {
                browser.url('');
            ...
            it('A-057-2 Story content correspond to gender', function () {
                const storyText = $$(sel.storyTextK)[0];
                expect(storyText).toHaveTextContaining(`${gender[2]}`);
                expect(storyText).toHaveTextContaining(`${gender[3]}`);
            });

            it('A-057-3 Story content correspond to Age', function () {
                const storyText = $$(sel.storyTextK)[0];
                expect(storyText).toHaveTextContaining(`${digitToWords(age)} years old`);
            });


            it('A-057-4 Story content correspond to Type of the story', function () {
                const storyName = $(sel.storyHeaderK);
        ...
        describe('A-057 Story content correspond to 1-4 fields', function () {
            ...
            it('A-057-1 Story content correspond to name', function () {
                browser.url('');
                inputValues4AndClick(name, gender[0], age, story[0]);
                const storyName = $(sel.storyHeaderK);
                expect(storyName).toHaveTextContaining(`${name}`);
    ...
    describe('Try again button exist and label is correct', function () {
        ...
        it('A-058 Label for Try again button exist', function () {    //TC-129a   //TC-086
            browser.url('');
        ...
        it('A-059 Label for Try again button = Try again!', function () { //TC-129b
            browser.url('');
